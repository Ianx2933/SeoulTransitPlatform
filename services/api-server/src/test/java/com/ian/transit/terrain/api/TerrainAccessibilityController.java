...
/**
 * REST controller exposing terrain screening queries over bus stops.
 *
 * Reads an immutable published snapshot. The dataset version is echoed on
 * every response so a caller can tell which DEM and boundary vintage produced the numbers.
 */
@RestController
