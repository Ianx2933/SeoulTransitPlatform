...
/** Reads an immutable published snapshot; no runtime spatial many-to-many join. */
@Repository
public class TerrainQueryRepository {
    private final JdbcTemplate jdbcTemplate;
    public TerrainQueryRepository(JdbcTemplate jdbcTemplate) { this.jdbcTemplate = jdbcTemplate; }
